...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&height=190&color=0:0B1021,50:1B4D89,100:00C2FF&text=Om%20Choudhary&fontAlign=50&fontAlignY=34&fontColor=FFFFFF&fontSize=48&desc=AI%2FML%20Technical%20Lead%20%7C%20Agentic%20AI%20%7C%20Multimodal%20Systems%20%7C%20Edge%20Inference&descAlign=50&descAlignY=56&descSize=16" alt="Om Choudhary profile banner" />
</p>
...
<table>
  <tr>
    <td width="50%">
      ...
      <p><b>Category:</b> Ambient AI · Multimodal AI · Audio/NLP · OCR · Clinical AI</p>
      <p>Prototype system combining audio transcription, handwritten-note extraction, multimodal fusion, and FastAPI serving patterns.</p>
      <p><b>Repo:</b> <code>ambient-multimodal-clinical-ai</code></p>
    </td>
    <td width="50%">
      <h3>🐦 BirdCLEF Bioacoustic Soundscape AI</h3>
      <p><b>Category:</b> Audio AI · Bioacoustics · Sound Event Detection · Deep Learning · Kaggle</p>
      <p>Audio classification toolkit for bird soundscape modeling, target generation, macro AUC evaluation, ensembling, and reproducible inference workflows.</p>
      <p><b>Repo:</b> <code>birdclef-bioacoustic-soundscape-ai</code></p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>🤖 Deterministic Agentic CX</h3>
      <p><b>Category:</b> Agents · RAG · Customer Experience · Safety · Orchestration</p>
      <p>Reference architecture for production agent systems where routing, permissions, retrieval, memory, and escalation are explicit system components.</p>
      <p><b>Status:</b> coming next</p>
    </td>
    <td width="50%">
      <h3>🛠️ Agentic PR Workflow Lab</h3>
      <p><b>Category:</b> Developer Agents · GitHub Automation · Jira Workflow · Tool Use</p>
      <p>Mock Jira-to-GitHub workflow where an agent receives a ticket, creates a plan, opens a PR, and links the work back to the issue trail.</p>
      <p><b>Status:</b> coming next</p>
    </td>
  </tr>
</table>
...
```mermaid
graph TD
    A[User Problem] --> B[Workflow + Success Metric]
    B --> C[Deterministic Control Plane]
    C --> D[Model / Agent Reasoning]
    C --> E[Retrieval + Memory]
    C --> F[Tools + Permissions]
    D --> G[Evaluation + Guardrails]
    E --> G
    F --> G
    G --> H[Observable Product Behavior]
    H --> I[Iteration Loop]
```
...
<p align="center">
  <b>Currently organizing my public portfolio around production AI systems:</b><br/>
